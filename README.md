## PumpCoin Core integration/staging tree
=====================================

Copyright (c) 2009-2012 Bitcoin Developers  
Copyright (c) 2012-2014 NovaCoin Developers 
Copyright (c) 2020- PumpCoin Developers
...
out collectively by the network. PumpCoin is the name of open source
software which enables the use of this currency.

PumpCoin first started in February 2020 using a variant of Litecoin using Scrypt as
...
PumpCoin is released under the terms of the MIT license. See [COPYING](COPYING) for more
...
completely stable. [Tags](https://github.com/freakcoderz/PumpCoin/tags) are created
