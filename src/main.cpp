...
const string strMessageMagic = "PumpCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if (nBestHeight > 0 && nBestHeight < 8) //premine 33% supply
    {
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "PumpCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Coronavirus: 'World faces worst recession since Great Depression'(BBC News) April 14, 2020";
        CTransaction txNew;
        txNew.nTime = 1586880894;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1586880894;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 39162 : 39162;
	 ...
	 if (true  && (block.GetHash() != hashGenesisBlock)) {
        ...
        assert(block.hashMerkleRoot == uint256("0xf5dec4022c83cbb6f0af59dfbcbf825f852a34feddb8594440cbd97a5d43cf38"));
    ...
    string strPubKey = "04ae7c0f67a3d42acd2c7579c8e70aa95226903b87390f7a0b07bcdbf56f0aaa36c58c01bf5fcdc82f7b49e84425c1223fc3844b7399165dce0993d15d5cb93fd9";
