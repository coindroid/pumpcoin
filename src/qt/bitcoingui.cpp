...
{
    resize(850, 550);
    setWindowTitle(tr("PumpCoin") + " - " + tr("Wallet"));
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a PumpCoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About PumpCoin"), this);
    aboutAction->setToolTip(tr("Show information about PumpCoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for PumpCoin"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("PumpCoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("PumpCoin client"));
...
{
        QDesktopServices::openUrl(QUrl("https://twitter.com/PumpCoin2020"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://t.me/joinchat/LjTUq1kOT7YAzGFui4y7gQ"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://www.reddit.com/r/"));
}

void BitcoinGUI::websiteActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://pumpcoin.tech"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://paperwallet.freakhouse.dev/?currency=PumpCoin"));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PumpCoin network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid PumpCoin address or malformed URI parameters."));
    }
